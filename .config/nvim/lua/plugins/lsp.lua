		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- TODO: fancy code actions
					map("<leader>ca", require("actions-preview").code_actions, "[C]ode [A]ction", { "n", "x" })
					map("<leader>e", vim.diagnostic.open_float, "open line diagnostic", { "n" })

					-- Find usages for the word under your cursor.
					...
					map("K", vim.lsp.buf.hover, "Hover Action", { "n" })
